...
export default function ProductImageCarousel({ images, productName, category }: { images: string[], productName: string, category: string }) {
  ...
  return (
    <div className="md:w-1/2 relative min-h-[400px] md:min-h-[600px] flex overflow-x-auto snap-x snap-mandatory no-scrollbar bg-neutral-900" ref={scrollContainerRef}>
